...
export default function Home() {
  ...
  const getNext3Days = () => {
    ...
    const nextDays = Object.entries(days)
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-900 text-white p-4 flex flex-col md:flex-row gap-6">
        {/* Sidebar */}
        <aside className="md:w-1/4 bg-gray-800 p-6 rounded-2xl shadow-lg flex flex-col justify-between">
          {current && (
            <>
              <div className="text-center">
                ...
                <h2 className="text-3xl font-bold mt-2">
                  {current.main.temp.toFixed(1)}°{unit}
                </h2>
              ...
              <div className="text-center text-sm mt-6">
                ...
                <p className="font-semibold text-lg mt-2">{weather?.city.name}</p>
              </div>
            </>
          )}
        </aside>
        ...
        <section className="flex-1 flex flex-col items-center justify-start">
          ...
          {loading && <p className="text-lg text-blue-400">Loading...</p>}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-4xl">
            {forecastCards.map((entry, idx) => (
              <div
                key={idx}
                className="bg-gray-800 rounded-xl shadow-md p-6 text-center hover:bg-gray-700 transition-all"
              >
                ...
                <p className="text-xl font-bold mt-2">
                  {entry.main.temp.toFixed(1)}°{unit}
                </p>
              </div>
            ))}
          </div>
          ...
          {current && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6 w-full max-w-2xl">
              <div className="bg-gray-800 p-6 rounded-xl shadow-md text-center hover:bg-gray-700 transition-all">
                <h3 className="text-lg font-semibold mb-2">Wind Speed</h3>
                <p className="text-2xl">{current.wind.speed} m/s</p>
              </div>
              <div className="bg-gray-800 p-6 rounded-xl shadow-md text-center hover:bg-gray-700 transition-all">
                <h3 className="text-lg font-semibold mb-2">Humidity</h3>
                <p className="text-2xl">{current.main.humidity}%</p>
              </div>
            </div>
          )}
        </section>
